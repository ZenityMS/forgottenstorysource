    ...
    public void buy(MapleClient c, int item, short quantity) {
        ...
        if (pItem.getBundles() > 0) {
            synchronized (items) {
                ...
                if (c.getPlayer().getMeso() >= pItem.getPrice() * quantity) { // i took the item dragged it to the hired merch, it subtracted and then when i dragged it back it worksed fine o-o um. if you multiply what you got back times the number you got back you get the right number o-o so... //
