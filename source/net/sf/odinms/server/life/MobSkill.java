...
public class MobSkill {
    ...
    public void applyEffect(MapleCharacter player, MapleMonster monster, boolean skill) {
        ...
        if (disease != null || dispel || seduce || banish) {
            if (new Random().nextInt(6) < 4) { // makes a number between 0 - 5. If 0, 1, 2, or 3 then give desiease
                if (skill && lt != null && rb != null) {
                    ...
                    for (MapleCharacter character : characters) {
                        if (dispel) {
                            ...
                            character.giveDebuff(MapleDisease.SEDUCE, this, false);
                            i++;
                        } else {
                            character.giveDebuff(disease, this, false);
                        }
                    }
                } else {
                    if (dispel) {
                        ...
                        player.giveDebuff(disease, this, false);
                    }
                }
            }
        }
