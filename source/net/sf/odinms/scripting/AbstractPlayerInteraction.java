...
public class AbstractPlayerInteraction {
    ...
    public int mapReactorCount() {
        MapleMap map = c.getPlayer().getMap();
        List<MapleMapObject> reactors = map.getMapObjectsInRange(new Point(0, 0), Double.POSITIVE_INFINITY, Arrays.asList(MapleMapObjectType.REACTOR));
        int count = reactors.size();
        return count;
    }
