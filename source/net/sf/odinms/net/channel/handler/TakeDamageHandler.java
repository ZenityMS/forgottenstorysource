...
public class TakeDamageHandler extends AbstractMaplePacketHandler {
    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (damage < -1 || damage > 100000) {
            AutobanManager.getInstance().autoban(player.getClient(), player.getName() + " took " + damage + " of damage.");
        ...
        if (damage > 0) {
            ...
            if (!player.isHidden() && player.isAlive()) {
                if (MapleLifeFactory.getMonster(monsteridfrom) != null) {
                    ...
                    player.dropMessage(1, "You have been suspected of Packet Editing. A GM will be notified.");
                }
            }
        }
    }
