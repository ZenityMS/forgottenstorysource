...
public interface WorldChannelInterface extends Remote, WorldChannelCommonOperations {
    ...
    public boolean setAllianceRanks(int id, String[] ranks) throws RemoteException;
    ...
    //public void broadcastToAlliance(int id, MaplePacket packet, int exception, int guildex) throws RemoteException;
