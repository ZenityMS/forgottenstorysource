...
public class WorldChannelInterfaceImpl extends UnicastRemoteObject implements WorldChannelInterface {
    ...
    @Override
    public void addPointsToTerritory(int guildid, int tid, int points) throws RemoteException {
        WorldRegistryImpl.getInstance().addPointsToTerritory(guildid, tid, points);
    }
    ...
    public void broadcastOwnerMessage(String sender, byte[] message) throws RemoteException {
        for (int i : WorldRegistryImpl.getInstance().getChannelServer()) {
            ChannelWorldInterface cwi = WorldRegistryImpl.getInstance().getChannel(i);
            try {
                cwi.broadcastOwnerMessage(sender, message);
            } catch (RemoteException e) {
                WorldRegistryImpl.getInstance().deregisterChannelServer(i);
            }
        }
    ...
    public void broadcastBlueFamilyMessage(String sender, byte[] message) throws RemoteException {
        for (int i : WorldRegistryImpl.getInstance().getChannelServer()) {
            ChannelWorldInterface cwi = WorldRegistryImpl.getInstance().getChannel(i);
            try {
                cwi.broadcastBlueFamilyMessage(sender, message);
            } catch (RemoteException e) {
                WorldRegistryImpl.getInstance().deregisterChannelServer(i);
            }
        }
    ...
    public void broadcastRedFamilyMessage(String sender, byte[] message) throws RemoteException {
        for (int i : WorldRegistryImpl.getInstance().getChannelServer()) {
            ChannelWorldInterface cwi = WorldRegistryImpl.getInstance().getChannel(i);
            try {
                cwi.broadcastRedFamilyMessage(sender, message);
            } catch (RemoteException e) {
                WorldRegistryImpl.getInstance().deregisterChannelServer(i);
            }
        }
    ...
    public void setAllianceCharacterOnline(MapleCharacter mc, boolean online) throws RemoteException {
    }
    ...
    @Override
    public void setAllianceNotice(int id, String notice) throws RemoteException {
        WorldRegistryImpl.getInstance().setAllianceNotice(id, notice);
    }
    ...
    @Override
    public boolean setGuildAlliance(int guild, MapleAlliance alliance) throws RemoteException {
        return WorldRegistryImpl.getInstance().setGuildAlliance(guild, alliance);
    }
