...
function action(mode, type, selection) {
	...
	cm.sendSimple ("Pick a Category#e#d" +
		...
		cm.dispose();
                ...
                cm.sendSimple ("You Currently have(#r" + cm.getPlayer().getVotePoints() + "#k) Vote Points."+
		 "#k\r\nHow much would you like?" +
                 "#k\r\n#L89##r10k NX Cash for 1Vote Point" +
                 "#k\r\n#L90##r20k NX Cash for 2Vote Point" +
                 "#k\r\n#L91##r30k NX Cash for 3Vote Point" +
                 "#k\r\n#L92##r40k NX Cash for 4Vote Point" +
                 "#k\r\n#L93##r50k NX Cash for 5Vote Point");
