...
function setup() {
	...
	var mob = net.sf.odinms.server.life.MapleLifeFactory.getMonster(8510000);
...
function playerEntry(eim, player) {
	...
	player.getClient().getSession().write(net.sf.odinms.tools.MaplePacketCreator.musicChange("Bgm12/AquaCave"));
}
