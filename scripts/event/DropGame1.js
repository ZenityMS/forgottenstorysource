...
function setup() {
	...
	exitMap = em.getChannelServer().getMapFactory().getMap(100000100); //Teh exit map :) <---------t
	doneMap = em.getChannelServer().getMapFactory().getMap(100000102);
	var instanceName = "DropGame1" + instanceId;
	...
	var map = mf.getMap(100000102);//wutt
	//map.shuffleReactors();
...
function playerEntry(eim, player) {
	var map = eim.getMapInstance(100000102);
