...
public class MapleMonster extends AbstractLoadedMapleLife {
    ...
    private boolean lolcakes = false;
    ...
    private TerritoryMonster territoryMonster = null;
...
//		int finalHP = hp / 10000 * ((int) (8000 + 10000 * Math.random()));
    ...
    public void switchController(MapleCharacter newController, boolean immediateAggro) {
        ...
        if (newController.invincibility) {
            return;
        }
    ...
    public int getCP() {
		...
		listeners = new LinkedList<MonsterListener>();
        attackers = new LinkedList<AttackerEntry>();
        try {
		//It gets finalized by the VM....
	//this.finalize();
        } catch (Throwable ex) {
            Logger.getLogger(MapleMonster.class.getName()).log(Level.SEVERE, null, ex);
        }
	}
        	public void setTerritoryMonster(TerritoryMonster t)
	{
		this.territoryMonster = t;
	}

	public TerritoryMonster getTerritoryMonster()
	{
		return territoryMonster;
	}
}
