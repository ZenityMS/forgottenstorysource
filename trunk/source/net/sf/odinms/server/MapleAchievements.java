...
public class MapleAchievements {
    ...
    protected MapleAchievements() {
        ...
        achievements.add(new Pair<Integer, MapleAchievement>(2, new MapleAchievement("completed the BossQuest", 17500, 30)));
        achievements.add(new Pair<Integer, MapleAchievement>(3, new MapleAchievement("killed Anego", 3500, 20)));
        achievements.add(new Pair<Integer, MapleAchievement>(4, new MapleAchievement("reached Level 70", 5000, 15)));
        achievements.add(new Pair<Integer, MapleAchievement>(5, new MapleAchievement("reached Level 120", 7500, 25)));
        achievements.add(new Pair<Integer, MapleAchievement>(6, new MapleAchievement("killed a boss", 1000, 10)));
        achievements.add(new Pair<Integer, MapleAchievement>(7, new MapleAchievement("equipped a dragon item", 3000, 10)));
        achievements.add(new Pair<Integer, MapleAchievement>(8, new MapleAchievement("reached the meso cap", 10000, 20)));
        achievements.add(new Pair<Integer, MapleAchievement>(9, new MapleAchievement("reached 50 fame", 2000, 25)));
        achievements.add(new Pair<Integer, MapleAchievement>(10, new MapleAchievement("killed their first Papulatus", 2500, 22)));
        ...
        achievements.add(new Pair<Integer, MapleAchievement>(16, new MapleAchievement("killed the almighty Zakum", 5000, 30)));
        achievements.add(new Pair<Integer, MapleAchievement>(17, new MapleAchievement("completed a trade", 250, 5, false)));
        achievements.add(new Pair<Integer, MapleAchievement>(18, new MapleAchievement("killed a Snail", 100, 5, false)));
        achievements.add(new Pair<Integer, MapleAchievement>(19, new MapleAchievement("killed a Pianus", 2500, 20)));
        ...
        achievements.add(new Pair<Integer, MapleAchievement>(26, new MapleAchievement("killed Horntail", 30000, 40)));
