...
public class MapleGuildCharacter implements java.io.Serializable // alias for a character
{
    ...
    public MapleGuildCharacter(int _id, int _lv, String _name, int _channel, int _job, int _rank, int _allianceRank, int _gid, boolean _on) {
        level = _lv;
        id = _id;
        name = _name;
        if (_on) {
