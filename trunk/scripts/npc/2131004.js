...
function action(mode, type, selection) {
	...
	if (cm.getPlayer().getMapId() == 101040002 || cm.getPlayer().getMapId() == 101040003 || cm.getPlayer().getMapId() == 102020000) {
			if (status == 0) {
				...
				if (selection == 1) {
					...
					if (cm.numSquadMembers(arena) < 2 && !cm.getChar()) {
						...
						if (em == null) {
							...
							em.startInstance(cm.getPlayer().getClient().getChannelServer().getMapleSquad(arena), cm.getChar().getMap());
		...
		} else if (cm.getPlayer().getMapId() == 101040002 || cm.getPlayer().getMapId() == 101040003 || cm.getPlayer().getMapId() == 102020000) {
