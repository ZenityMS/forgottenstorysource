...
function action(mode, type, selection) {
	...
	if (mode == 1)
		...
		status--;
	if (status == 0) {
    cm.sendSimple ("I have a lot of things that I can do, Please choose one \b\r\n#L0##r#eTravel to Towns\n\#l\r\n#L1##dJob Advancement\n\#l\r\n#L2##bTrade Any Types Of Points\n\#l\r\n#L3##dAll Party Quests!\n\#l\r\n#L4##rDo The Rebirth Quest For Rebirth Points\n\#l\r\n#L6##bDo Jump Quests For Jump Points!\n\#l\r\n#L7##dAll In One Shop\r\n#L8##bTrade Maple Leaves\r\n#L9##b#rSkill Maxer\r\n#L10##b#rMeso Converter\r\n#L11##bStat Resetter\r\n#L13##rRemove Rings\r\n#L12##b#bOther");

	 } else if (selection == 12) {
            cm.sendSimple("Please choose one \b\r\n#L90##r#eRock, Paper Scissors\n\#l " +
                          "\r\n#L91##r#eMegaphone Seller\n\#l" +
                          "\r\n#L92##r#eMusic Player\n\#l" +
                          "\r\n#L93##r#eGo to PVP\n\#l");
	 } else if (selection == 0) {
		cm.openNpc (9000020)
		...
		cm.openNpc (1052013)
           ...
           // cm.clearSkills(); 
            ...
            cm.teachSkill(5220011,20,20); // Ended CORSAIR Skills
            cm.sendOk ("All done! Have fun in MapleZtory :)");
            cm.dispose();
